...
from comparable_feature import calculate_iou, calculate_image_similarity, calculate_keypoint_matching
...
if __name__ == "__main__":
    while True:
        image_path = "../../data/test_data/4-2.png"
        template_path = "../../data/test_data/4-2.png"
        image = cv2.imread(image_path, cv2.IMREAD_GRAYSCALE)
        template = cv2.imread(template_path, cv2.IMREAD_GRAYSCALE)
