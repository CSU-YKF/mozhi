"""
Contains functions for preprocess the input image before passing it to the model.
"""
...
# Additional preprocess functions can be added based on the `preprocess` Python file
